...
const products = [
  ...
  { name: 'Night Stripe Hoodie', price: 969, category: 'Hoodies', description: 'Two-tone stripe trim and a street-cut silhouette with deep pockets.', imageURL: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=900&q=80', stock: 9 },
  ...
  { name: 'Urban Echo Hoodie', price: 919, category: 'Hoodies', description: 'Luxe fleece feel with a slightly tapered, fashion-first fit.', imageURL: 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?auto=format&fit=crop&w=900&q=80', stock: 8 },
  { name: 'Horizon Long Sleeve', price: 689, category: 'T-shirts', description: 'Long sleeve staple crafted for cooler evenings and layered styling.', imageURL: 'https://images.unsplash.com/photo-1506529082632-69ba78d64245?auto=format&fit=crop&w=900&q=80', stock: 13 },
  { name: 'Trackloop Sneaker', price: 1849, category: 'Sneakers', description: 'Chunky sole with comfort-first cushioning and textured finish.', imageURL: 'https://images.unsplash.com/photo-1511614387149-abc4cecb108e?auto=format&fit=crop&w=900&q=80', stock: 7 },
  { name: 'Rooftop Buckle', price: 579, category: 'Accessories', description: 'Minimal leather belt styled to finish clean casual outfits.', imageURL: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?auto=format&fit=crop&w=900&q=80', stock: 11 },
  { name: 'Grid Fleece Hoodie', price: 929, category: 'Hoodies', description: 'Cotton fleece hoodie with grid texture and laid-back volume.', imageURL: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=900&q=80', stock: 12 },
  { name: 'Minimal Wave Tee', price: 449, category: 'T-shirts', description: 'Soft touch tee with a slightly relaxed shape and premium drape.', imageURL: 'https://images.unsplash.com/photo-1556821552-7f41c5d440db?auto=format&fit=crop&w=900&q=80', stock: 21 },
  { name: 'Ridge Runner', price: 1889, category: 'Sneakers', description: 'A premium runner balancing cushioning, grip, and street style.', imageURL: 'https://images.unsplash.com/photo-1549622917-50a23e5a1cda?auto=format&fit=crop&w=900&q=80', stock: 6 },
  { name: 'Peak Knit Cap', price: 389, category: 'Accessories', description: 'Clean knit cap in a soft brushed finish with subtle logo detail.', imageURL: 'https://images.unsplash.com/photo-1572307480616-40629fe7e2b0?auto=format&fit=crop&w=900&q=80', stock: 20 },
  { name: 'Noir Crew Hoodie', price: 949, category: 'Hoodies', description: 'Dark premium fleece with a quiet logo and wide drape.', imageURL: 'https://images.unsplash.com/photo-1529139574466-a303027c1d8b?auto=format&fit=crop&w=900&q=80', stock: 10 },
  { name: 'Shell Layer Tee', price: 469, category: 'T-shirts', description: 'Tighter fit in a light premium knit built for warmer layers.', imageURL: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=900&q=80', stock: 19 },
  { name: 'Mosaic Court', price: 1769, category: 'Sneakers', description: 'Modern court sneaker with elevated cushioning and clean finish.', imageURL: 'https://images.unsplash.com/photo-1525895917283-3a1c8aeb446e?auto=format&fit=crop&w=900&q=80', stock: 9 },
  { name: 'Transit Pouch', price: 329, category: 'Accessories', description: 'Mini utility pouch for essentials, cards, and daily carry.', imageURL: 'https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?auto=format&fit=crop&w=900&q=80', stock: 22 }
];
